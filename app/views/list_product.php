...
<section id="product-section" class="all_products">
   <div id="product"><h2>Tất cả sản phẩm</h2></div>
   <div class="container">
         ...
         <div class="product swiper-slide">
            <form action="<?php echo BASE_URL ?>/giohang/themgiohang" method="post">
               ...
               <div class="img_product">
                  <a href="<?php echo BASE_URL ?>/sanpham/details_product/<?php echo $product['id_product'] ?>"><img src="<?php echo BASE_URL ?>/public/uploads/product/<?php echo $product['image_product'] ?>" alt=""></a>
