...
<section id="form">
    ...
    <form action="<?php echo BASE_URL ?>/product/update_category_product/<?php echo $cate['id_category_product'] ?>" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea type="text" value="<?php echo $cate['title_category_product'] ?>" name="desc_category_product" rows="5" style="font-size: 30px; resize: none;width:100%" class="form-control">
